...
import { fetchPosts, Post } from "@/app/(pages)/blog/basehub"
import { formatDate } from "@/lib/utils"
import { getFeaturedPost } from "../featured"
...
export const BlogList = async ({ params }: { params: { slug: string[] } }) => {
  ...
  const filteredPosts = posts.filter(post => post._slug !== featuredPost?._slug)
        ...
        >
          ...
          >
            ...
            <div className="relative col-span-6 flex gap-1 lg:col-span-2 lg:col-start-9 lg:col-end-10">
              {post.categories?.items?.map((category: Category) => (
                <p
                  key={category._title}
